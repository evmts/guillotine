...
test "differential: signed arithmetic operations" {
    ...
    const bytecode = [_]u8{
        ...
        0x7f, // PUSH32
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,  // bytes 1-8
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,  // bytes 9-16
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,  // bytes 17-24
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xf8,  // bytes 25-32 of -8
        0x60, 0x03, // PUSH1 3
        0x05,       // SDIV (result: -2)
