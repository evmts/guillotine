...
test "ADD fusion: PUSH 5, PUSH 10, ADD vs PUSH 5, MSTORE, PUSH 10, ADD" {
    ...
    var vm_instance_fusion = try evm.Evm.init(allocator, db_interface_fusion, null, null, null, null, null);
    ...
    var vm_instance_non_fusion = try evm.Evm.init(allocator, db_interface_non_fusion, null, null, null, null, null);
