...
test "Security: Stack overflow protection across all operation types" {
    ...
    var builder = try Evm.Evm.init(allocator, db_interface, null, null, null, null, null);
