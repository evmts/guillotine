...
test "Integration: Arithmetic with conditional jumps" {
    ...
    _ = try vm.table.execute(&vm, &frame, 0x60);
    ...
    _ = try vm.table.execute(&vm, &frame, 0x11);
    ...
    _ = try vm.table.execute(&vm, &frame, 0x57);
...
test "Integration: Division by zero handling in expression" {
    ...
    _ = try vm.table.execute(&vm, &frame, 0x04);
...
test "Integration: Comparison chain for range checking" {
    ...
    _ = try vm.table.execute(&vm, &frame, 0x15);
...
test "Integration: Signed arithmetic with comparisons" {
    ...
    _ = try vm.table.execute(&vm, &frame, 0x12);
    ...
    try frame.stack.push(3);
    _ = try vm.table.execute(&vm, &frame, 0x05);
