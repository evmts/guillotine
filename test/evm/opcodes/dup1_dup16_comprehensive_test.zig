...
test "DUP1 (0x80): Duplicate 1st stack item" {
    ...
    // Execute DUP1
    const result = try evm.table.execute(interpreter, state, 0x80);
...
test "DUP2 (0x81): Duplicate 2nd stack item" {
    ...
    // Execute DUP2
    frame.pc = 4;
    const result = try evm.table.execute(interpreter, state, 0x81);
    try testing.expectEqual(@as(usize, 1), result.bytes_consumed);
...
test "DUP3-DUP5: Various duplications" {
    ...
    frame.pc = 0;
    var result = try evm.table.execute(interpreter, state, 0x82);
    try testing.expectEqual(@as(usize, 1), result.bytes_consumed);
    ...
    frame.pc = 1;
    result = try evm.table.execute(interpreter, state, 0x83);
    try testing.expectEqual(@as(usize, 1), result.bytes_consumed);
    ...
    frame.pc = 2;
    result = try evm.table.execute(interpreter, state, 0x84);
    try testing.expectEqual(@as(usize, 1), result.bytes_consumed);
...
test "DUP6-DUP10: Mid-range duplications" {
    ...
    frame.pc = 0;
    const result = try evm.table.execute(interpreter, state, 0x85);
    try testing.expectEqual(@as(usize, 1), result.bytes_consumed);
    ...
    frame.pc = 1;
    _ = try evm.table.execute(interpreter, state, 0x86);
    try testing.expectEqual(@as(u256, 0x50), frame.stack.data[frame.stack.size - 1]);

    // Execute DUP8 (should duplicate 0x40)
    frame.pc = 2;
    _ = try evm.table.execute(interpreter, state, 0x87);
    ...
    frame.pc = 3;
    _ = try evm.table.execute(interpreter, state, 0x88);
    ...
    frame.pc = 4;
    _ = try evm.table.execute(interpreter, state, 0x89);
...
test "DUP11-DUP16: High-range duplications" {
    ...
    frame.pc = 0;
    _ = try evm.table.execute(interpreter, state, 0x8A);
    try testing.expectEqual(@as(u256, 0x600), frame.stack.data[frame.stack.size - 1]);

    // Execute DUP12 (position 12 contains 0x600)
    frame.pc = 1;
    _ = try evm.table.execute(interpreter, state, 0x8B);
    try testing.expectEqual(@as(u256, 0x600), frame.stack.data[frame.stack.size - 1]);

    // Execute DUP13 (position 13 contains 0x600)
    frame.pc = 2;
    _ = try evm.table.execute(interpreter, state, 0x8C);
    try testing.expectEqual(@as(u256, 0x600), frame.stack.data[frame.stack.size - 1]);

    // Execute DUP14 - position 14 is 0x600
    frame.pc = 3;
    _ = try evm.table.execute(interpreter, state, 0x8D);
    try testing.expectEqual(@as(u256, 0x600), frame.stack.data[frame.stack.size - 1]);

    // Execute DUP15 - position 15 from top
    frame.pc = 4;
    _ = try evm.table.execute(interpreter, state, 0x8E);
    try testing.expectEqual(@as(u256, 0x600), frame.stack.data[frame.stack.size - 1]);

    // Execute DUP16 - position 16 from top
    frame.pc = 5;
    _ = try evm.table.execute(interpreter, state, 0x8F);
...
test "DUP16 (0x8F): Duplicate 16th stack item (maximum)" {
    ...
    const result = try evm.table.execute(interpreter, state, 0x8F);
    try testing.expectEqual(@as(usize, 1), result.bytes_consumed);
...
test "DUP operations: Stack underflow" {
    ...
    frame.pc = 0;
    var result = evm.table.execute(interpreter, state, 0x80);
    ...
    // DUP1 should succeed
    const result2 = try evm.table.execute(interpreter, state, 0x80);
    try testing.expectEqual(@as(usize, 1), result2.bytes_consumed);

    // DUP2 should succeed with 2 items on stack
    frame.pc = 1;
    const result3 = try evm.table.execute(interpreter, state, 0x81);
    ...
    frame.pc = 2;
    _ = try evm.table.execute(interpreter, state, 0x85);

    // DUP16 should fail (only 7 items on stack)
    frame.pc = 3;
    result = evm.table.execute(interpreter, state, 0x8F);
    try testing.expectError(ExecutionError.Error.StackUnderflow, result);
}
...
test "DUP operations: Sequential duplications" {
    ...
    // Execute DUP2
    frame.pc = 7;
    _ = try evm.table.execute(interpreter, state, 0x81);
    ...
    // Execute DUP5
    frame.pc = 8;
    _ = try evm.table.execute(interpreter, state, 0x84);
...
test "DUP operations: Boundary test with exact stack size" {
    ...
    const result = evm.table.execute(interpreter, state, 0x8F);
    try testing.expectError(ExecutionError.Error.StackUnderflow, result);
}
