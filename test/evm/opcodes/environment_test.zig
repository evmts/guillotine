...
test "Environment: ADDRESS opcode" {
    ...
    _ = try evm.table.execute(&evm, &frame, 0x30);
...
test "Environment: BALANCE opcode" {
    ...
    _ = try evm.table.execute(&evm, &frame, 0x31);
...
test "Environment: ORIGIN and CALLER opcodes" {
    ...
    // Test ORIGIN
    _ = try evm.table.execute(&evm, &frame, 0x32);
    ...
    // Test CALLER
    frame.stack.clear();
    _ = try evm.table.execute(&evm, &frame, 0x33);
...
test "Environment: CALLVALUE opcode" {
    ...
    // Execute CALLVALUE
    _ = try evm.table.execute(&evm, &frame, 0x34);
...
test "Environment: GASPRICE opcode" {
    ...
    // Execute GASPRICE
    _ = try evm.table.execute(&evm, &frame, 0x3A);
...
test "Environment: EXTCODESIZE opcode" {
    ...
    _ = try evm.table.execute(&evm, &frame, 0x3B);
...
test "Environment: EXTCODECOPY opcode" {
    ...
    _ = try evm.table.execute(&evm, &frame, 0x3C);
...
test "Environment: EXTCODEHASH opcode" {
    ...
    const bob_u256 = primitives.Address.to_u256(bob_addr);
    try frame.stack.append(bob_u256);
    _ = try evm.table.execute(&evm, &frame, 0x3F);
...
test "Environment: SELFBALANCE opcode (Istanbul)" {
    ...
    // Execute SELFBALANCE
    _ = try evm.table.execute(&evm, &frame, 0x47);
...
test "Environment: CHAINID opcode (Istanbul)" {
    ...
    // Execute CHAINID
    _ = try evm.table.execute(&evm, &frame, 0x46);
...
test "Environment: Stack underflow errors" {
    ...
    try testing.expectError(ExecutionError.Error.StackUnderflow, evm.table.execute(&evm, &frame, 0x31));

    try testing.expectError(ExecutionError.Error.StackUnderflow, evm.table.execute(&evm, &frame, 0x3B));

    try testing.expectError(ExecutionError.Error.StackUnderflow, evm.table.execute(&evm, &frame, 0x3F));
    ...
    // Only 3 items
    try testing.expectError(ExecutionError.Error.StackUnderflow, evm.table.execute(&evm, &frame, 0x3C));
}
