...
export const sampleContracts: SampleContract[] = [
	{
		...
		description:
			"Simple arithmetic: PUSH1 5, PUSH1 10, ADD, PUSH1 3, MUL (Result: 45)",
		bytecode: "0x6005600a01600302",
	},
	{
		name: "Memory Operations",
		description:
			"Memory store/load: Store 0xdeadbeef at offset 0x00, then load it back",
		bytecode: "0x63deadbeef6000526000516000556000546001600055600154",
	},
	{
		name: "Storage Operations",
		description:
			"Storage read/write: Store values in slots 0 and 1, then read them",
		bytecode: "0x600a600055601e600155600054600154600255600254",
	},
	{
		name: "PUSH Variations",
		description:
			"Different PUSH sizes: PUSH1(0xff), PUSH2(0xffff), PUSH3(0xffffff), PUSH4(0xffffffff)",
	...
	},
	{
		...
		bytecode:
			"0x7f48656c6c6f000000000000000000000000000000000000000000000000000000600052600560002060005260206000f3",
	},
	{
		name: "Comprehensive Test",
		description:
			"Full EVM showcase: arithmetic, memory, storage, events, returns, comparisons, jumps",
		bytecode:
	...
	},
	{
		...
		description:
			"JUMP, JUMPI, PC: Conditional and unconditional jumps with PC checks",
	...
	},
	{
		...
		description:
			"AND, OR, XOR, NOT, SHL, SHR, SAR: Full bitwise operation suite",
		bytecode: "0x60ff60aa166055601760aa60ff18196003601b6003601c600360041d",
	},
	{
		name: "Address and Balance",
		description:
			"ADDRESS, BALANCE, CALLER, ORIGIN: Get contract and account info",
		bytecode: "0x3033313234",
	},
	{
		name: "Block Information",
		description:
			"TIMESTAMP, NUMBER, COINBASE, GASLIMIT, CHAINID: Get block info",
	...
	},
	{
		...
		bytecode:
			"0x7f48656c6c6f20576f726c642100000000000000000000000000000000000000006000526020600052600c6014f3",
	},
	{
		name: "Event Emission",
	...
	},
	{
		...
		description:
			"Mapping simulation: Store at computed slots like mapping[key] = value",
		bytecode:
