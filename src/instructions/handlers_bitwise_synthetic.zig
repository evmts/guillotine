...
pub fn Handlers(comptime FrameType: type) type {
    return struct {
        ...
        pub fn push_and_inline(self: *FrameType, cursor: [*]const Dispatch.Item) callconv(FrameType.getInterpreterCallConv()) Error!noreturn {
        ...
        pub fn push_and_pointer(self: *FrameType, cursor: [*]const Dispatch.Item) callconv(FrameType.getInterpreterCallConv()) Error!noreturn {
            const dispatch_opcode_data = @import("../preprocessor/dispatch_opcode_data.zig");
        ...
        pub fn push_or_inline(self: *FrameType, cursor: [*]const Dispatch.Item) callconv(FrameType.getInterpreterCallConv()) Error!noreturn {
            const dispatch_opcode_data = @import("../preprocessor/dispatch_opcode_data.zig");
        ...
        pub fn push_or_pointer(self: *FrameType, cursor: [*]const Dispatch.Item) callconv(FrameType.getInterpreterCallConv()) Error!noreturn {
            const dispatch_opcode_data = @import("../preprocessor/dispatch_opcode_data.zig");
        ...
        pub fn push_xor_inline(self: *FrameType, cursor: [*]const Dispatch.Item) callconv(FrameType.getInterpreterCallConv()) Error!noreturn {
            const dispatch_opcode_data = @import("../preprocessor/dispatch_opcode_data.zig");
        ...
        pub fn push_xor_pointer(self: *FrameType, cursor: [*]const Dispatch.Item) callconv(FrameType.getInterpreterCallConv()) Error!noreturn {
            const dispatch_opcode_data = @import("../preprocessor/dispatch_opcode_data.zig");
