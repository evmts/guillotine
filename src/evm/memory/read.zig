...
pub inline fn get_u256(self: *const memory.DefaultMemory, relative_offset: usize) errors.MemoryError!u256 {
...
pub inline fn get_slice(self: *const memory.DefaultMemory, relative_offset: usize, len: usize) errors.MemoryError![]const u8 {
...
pub inline fn get_byte(self: *const memory.DefaultMemory, relative_offset: usize) errors.MemoryError!u8 {
