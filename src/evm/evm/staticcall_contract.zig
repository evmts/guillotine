...
pub fn staticcall_contract(self: *@This(), caller: primitives.Address.Address, to: primitives.Address.Address, input: []const u8, gas: u64) StaticcallContractError!CallResult {
